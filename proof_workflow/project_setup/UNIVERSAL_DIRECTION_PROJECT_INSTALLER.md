...
Layer B - Shared Proof Runtime Packs:

- semantic kernel and proof runtime cache
...
Upload these shared packs for all new Direction Proof Projects:
...
- `proof_workflow/project_packs/MIGRATION_LEGACY_IMPORT_PACK.md`
- `proof_workflow/project_packs/GOVERNANCE_MAINTENANCE_PACK.md`
...
Old chats are not source of truth. Old Direction Map, Active Goal, Current Phase, Portfolio Queue, project files, project setup files, phases, and execution logs do not become accepted proof state without a verified committed Receipt.
...
Before using a new Direction Proof Project for material work, confirm:
