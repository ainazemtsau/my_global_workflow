...
```text
<DIRECTION_DISPLAY_NAME> — Proof
```

Project Instructions source:

- `directions/<direction-id>/proof/project_setup/CHATGPT_PROJECT_INSTRUCTIONS.md`
- or universal installer instructions generated from `proof_workflow/project_setup/UNIVERSAL_DIRECTION_PROJECT_INSTRUCTIONS.md`
