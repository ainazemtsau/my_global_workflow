...
Receipt Card records a proof-carrying result, including claims, evidence, assumptions, residual Obligations, invariant checks, proof policy result, and commit recommendation.
...
END_OF_FILE: proof_workflow/project_packs/TRANSPORT_CORE_PACK.md
