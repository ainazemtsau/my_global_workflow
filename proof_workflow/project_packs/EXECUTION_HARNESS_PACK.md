...
source_manifest:
  - proof_workflow/execution/00_EXECUTION_HARNESS.md
  - proof_workflow/execution/01_PROJECT_SETUP_PROTOCOL.md
  - proof_workflow/execution/02_EXECUTION_OBLIGATIONS.md
  - proof_workflow/execution/03_CODEX_OPERATOR_PROTOCOL.md
  - proof_workflow/execution/04_VALIDATION_PROTOCOL.md
  - proof_workflow/execution/05_COMPLEX_TECHNICAL_MISSION_PROTOCOL.md
  - proof_workflow/execution/06_HUMAN_GUIDED_EXECUTION_PROTOCOL.md
  - proof_workflow/execution/07_TECHNICAL_MEMORY_POLICY.md
  - proof_workflow/execution/08_EXECUTION_EVALS.md
  - proof_workflow/invariants/EXECUTION_INVARIANTS.md
  - proof_workflow/transport/CODEX_EXECUTION_LAUNCH_CARD.md
  - proof_workflow/transport/EXECUTION_RECEIPT_CARD.md
  - proof_workflow/transport/PROJECT_SETUP_RECEIPT_CARD.md
  - proof_workflow/transport/VALIDATION_RECEIPT_CARD.md
  - proof_workflow/transport/HUMAN_ACTION_CARD.md
---
...
END_OF_FILE: proof_workflow/project_packs/EXECUTION_HARNESS_PACK.md
