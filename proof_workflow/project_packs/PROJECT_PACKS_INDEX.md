...
For ordinary Direction proof Projects, default upload can be reduced to:
...
Use `proof_workflow/project_packs/EXECUTION_HARNESS_PACK.md` only when the Direction Project intentionally works on execution readiness, CodexRun, validation, complex technical missions, human-guided execution, or product repo technical memory.
...
END_OF_FILE: proof_workflow/project_packs/PROJECT_PACKS_INDEX.md
