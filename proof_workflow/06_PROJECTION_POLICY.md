...
Active Frontier is a computed eligibility view over open Obligations under current Horizon, constraints, proof policy, and gate status.
...
END_OF_FILE: proof_workflow/06_PROJECTION_POLICY.md
