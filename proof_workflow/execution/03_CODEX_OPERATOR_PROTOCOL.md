...
Mode does not override the Obligation, Launch Card, proof policy, or allowed/forbidden surfaces.
...
END_OF_FILE: proof_workflow/execution/03_CODEX_OPERATOR_PROTOCOL.md
