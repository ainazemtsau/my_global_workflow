...
Validation gaps block done claims unless an accepted proof policy explicitly permits a narrower partial result.

END_OF_FILE: proof_workflow/execution/04_VALIDATION_PROTOCOL.md
