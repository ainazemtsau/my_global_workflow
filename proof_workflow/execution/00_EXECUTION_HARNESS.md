...
Execution Harness is the Gate 2 runtime extension for making product, project, repository, tool, and external work proof-carrying.
...
This Gate 2 patch defines shared workflow specifications under `proof_workflow/`.
...
END_OF_FILE: proof_workflow/execution/00_EXECUTION_HARNESS.md
