...
- Launch is invalid without target binding, setup status, acceptance predicate, validation plan, allowed/forbidden surfaces, proof policy, and return schema.
...
END_OF_FILE: proof_workflow/transport/CODEX_EXECUTION_LAUNCH_CARD.md
