...
Old semantics are not authority in the new proof workflow.
...
Old project files are not proof workflow source of truth.

## Proof-Carrying Migration

Migration itself must be proof-carrying.
...
END_OF_FILE: proof_workflow/07_MIGRATION_PROTOCOL.md
