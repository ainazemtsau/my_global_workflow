...
Codex must apply approved packets to GitHub markdown files, verify the result, commit, push, and report which ChatGPT Project Files must be refreshed manually.
