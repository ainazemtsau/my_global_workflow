...
# Workflow Governance — Proof Project Files Manifest

Project name: Workflow Governance — Proof
...
1. Create ChatGPT Project named "Workflow Governance — Proof".
...
5. Start a new chat with root objective confirmation.
