# 08 Direction Map - Workflow Governance

```yaml
artifact_control:
  artifact_name: "08 Direction Map - Workflow Governance"
  schema: direction_map.v1
  owner_layer: persistence
  status: draft_needs_m0_review
  repo_path: "directions/workflow-governance/project_files/08_DIRECTION_MAP.md"
  default_load: yes
...
`END_OF_FILE: directions/workflow-governance/project_files/08_DIRECTION_MAP.md`
