...
Run Workflow OS for Direction `indie-game-development`.
...
Preserve ideas; do not act on them prematurely. If the user mentions marketing, Steam, Discord, Patreon, Kickstarter, business, tech, implementation, or production outside the active Obligation, extract only what is relevant now and park the rest.
