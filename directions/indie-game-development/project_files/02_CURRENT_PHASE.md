...
active_goal_projection:
  ...
  status: none_pending_m0_direction_map_review
  last_completed_goal_id: first-technical-nucleus-functional-spec
  last_completed_goal_result: r1_completed_verified_specification_accepted
  ...
  next_goal_candidate: none_pending_m0_review
  goal_shape_note: "R1 accepted the first technical nucleus functional specification; M0 is next."
...
phase_closure_contract_status_update:
  ...
  after_goal_gate_policy:
    ...
    - "Run M0_DIRECTION_MAP before P9, G0, E1, or implementation route selection."
...
- Active Goal status: `none_pending_m0_direction_map_review`
...
M0 must review the active front after the specification Goal was accepted. It must not perform implementation, Unity bootstrap, old-code transfer, Codex product/project execution, or Phase close inside M0.

Do not proceed to P9, G0, E1, project bootstrap, or durable implementation planning until M0 selects a basis-valid next route.
...
Current next route after R1 acceptance: `M0_DIRECTION_MAP`.
