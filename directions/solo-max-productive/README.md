...
- `knowledge/` contains reusable Direction knowledge when present as GitHub
  files.
- `domain_docs/` contains canonical domain documentation when present.
- `projects/` contains project metadata.

Only verified Receipts committed to `workflow/LEDGER.md` create accepted state
for this Direction. The current Ledger has no accepted root objective and no
