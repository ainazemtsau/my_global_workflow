...
source_manifest:
  - execution/00_EXECUTION_HARNESS.md
  - execution/01_PROJECT_SETUP_PROTOCOL.md
  - execution/02_EXECUTION_OBLIGATIONS.md
  - execution/03_CODEX_OPERATOR_PROTOCOL.md
  - execution/04_VALIDATION_PROTOCOL.md
  - execution/05_COMPLEX_TECHNICAL_MISSION_PROTOCOL.md
  - execution/06_HUMAN_GUIDED_EXECUTION_PROTOCOL.md
  - execution/07_TECHNICAL_MEMORY_POLICY.md
  - execution/08_EXECUTION_EVALS.md
  - invariants/EXECUTION_INVARIANTS.md
  - transport/CODEX_EXECUTION_LAUNCH_CARD.md
  - transport/EXECUTION_RECEIPT_CARD.md
  - transport/PROJECT_SETUP_RECEIPT_CARD.md
  - transport/VALIDATION_RECEIPT_CARD.md
  - transport/HUMAN_ACTION_CARD.md
---
...
END_OF_FILE: project_packs/EXECUTION_HARNESS_PACK.md
