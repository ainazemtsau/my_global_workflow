...
source_manifest:
  ...
  - 05_OPERATOR_CATALOG_POLICY.md
  - 06_PROJECTION_POLICY.md
  - 07_MIGRATION_PROTOCOL.md
  - invariants/CORE_INVARIANTS.md
  - evals/MIGRATION_VALIDATION_CHECKLIST.md
---
...
END_OF_FILE: project_packs/WORKFLOW_BASE_PACK.md
