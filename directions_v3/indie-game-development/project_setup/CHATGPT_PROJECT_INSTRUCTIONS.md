...
source_status: accepted_project_instructions_source
...
This repository source does not update the actual ChatGPT Project Instructions UI by itself.

The human must manually copy only the UI payload between the markers into the Project Instructions UI after this package is accepted and merged.

END_OF_FILE: directions_v3/indie-game-development/project_setup/CHATGPT_PROJECT_INSTRUCTIONS.md
