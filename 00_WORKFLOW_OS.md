...
This Gate 1 install performs no migration. It creates only the shared kernel and protocol documentation under the repository root.
...
Gate 2 execution specifications live under `execution/`.
