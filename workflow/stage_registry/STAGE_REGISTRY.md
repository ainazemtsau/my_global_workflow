...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ROUTER_STAGE_LAUNCHER | Router / Stage Launcher | Determine the shortest safe path to the next Direction-visible result and produce Launch Card / Context Request / Human Decision / Stop. | `workflow/stage_prompts/ROUTER_STAGE_LAUNCHER.md` | present | chatgpt_direction_project | available | any appropriate stage, Context Request, Human Decision, Stop |
