...
- [ ] All created shared workflow files are under `workflow/**`.
...
- [ ] Manifest includes `workflow/policies/10_CONTEXT_AUTHORITY_POLICY.md`.
...
END_OF_FILE: workflow/evals/MIGRATION_VALIDATION_CHECKLIST.md
