...
Purpose: run Workflow OS for <DIRECTION_DISPLAY_NAME>.
...
- `directions/<DIRECTION_ID>/<ACTIVE_DIRECTION_STATE>/LEDGER.md`
- `directions/<DIRECTION_ID>/<ACTIVE_DIRECTION_STATE>/OBLIGATIONS.md`
- `directions/<DIRECTION_ID>/<ACTIVE_DIRECTION_STATE>/RECEIPTS_INDEX.md`
- `directions/<DIRECTION_ID>/<ACTIVE_DIRECTION_STATE>/COMMIT_SCOPES.md`
- `directions/<DIRECTION_ID>/<ACTIVE_DIRECTION_STATE>/DASHBOARD.md`
- `directions/<DIRECTION_ID>/<ACTIVE_DIRECTION_STATE>/MIGRATION_RECEIPT.md`
...
- preserve useful off-scope input as candidate/residual context
- do not treat examples, urgency, anxiety, platform mentions, or brainstorming as accepted decisions
