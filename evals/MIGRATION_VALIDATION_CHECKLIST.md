...
- [ ] All created files are under `00_*.md`, root workflow directories, and project pack files only.
...
- [ ] Manifest includes `10_CONTEXT_AUTHORITY_POLICY.md`.
...
END_OF_FILE: evals/MIGRATION_VALIDATION_CHECKLIST.md
