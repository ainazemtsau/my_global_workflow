...
| WIP-лимиты работают по закону Литтла; переключение контекста съедает до 20-40% ([APA](https://www.apa.org/topics/research/multitasking)) | Гейт G1; pulse-пункт 8 о распылении владельца |
