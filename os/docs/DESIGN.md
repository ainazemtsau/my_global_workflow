...
```
os/                          ← система (правила; меняется редко, по трению)
  KERNEL.md                  ← конституция: сессия, состояние, пакеты, 8 гейтов
  plays/  frame shape work review research pulse repair
  schema/ direction-files, packets
  adapters/ chatgpt-project, coding-agent, autonomy
  FRICTION.md, BOOTSTRAP.md, docs/
