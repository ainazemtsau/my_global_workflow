...
| R-20 параллельные затеи | dynamic owner-created tracks; owner-set WIP limit; ≤1 root CALL/track; primary один владеет бетом/tasks |
