...
| R-20 параллельные затеи | ветви дерева; G1 держит WIP; pulse-8 следит за распылением |
...
| R-43 параллельные направления | adapters/worktrees.md (worktree на направление, rebase-retry, «одно перо» на направление) |
