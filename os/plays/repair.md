...
Writes: NOW.md; TREE/CHARTER hygiene trims only with G9 approval; LOG; knowledge reset-boundary/stale tombstones and work-surface retirement banners only when they remove false routing authority; optional unrecoverable-state snapshot; optional LOG archive.
