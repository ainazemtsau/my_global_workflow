...
6. **Close (owner)** — RESULT with `owner_approved` marks for charter and root (G9); log line; next = CALL for a map session carrying the candidate outcomes.
