...
4. **Hot-state hygiene** — is NOW still hot state (no closed open_calls, answered decisions, prose next)? Are NOW.md/CHARTER.md/TREE.md/LOG.md each within the schema's soft line ceiling, with no inlined evidence quotes or invented fields? If drifted, propose a repair CALL; do not compact here.
