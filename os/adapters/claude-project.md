...
3. Connect the GitHub integration / repo sync to `ainazemtsau/my_global_workflow` (project knowledge), or rely on self-contained CALLs and pasted cards — both work.
