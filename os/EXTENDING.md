...
1. **Additivity.** No level may override gates G1–G10, the CALL/RESULT schemas, or the five state file types. Local plays are procedure files, not state — the five-type budget is untouched.
