...
## ADDENDUM-3 (same session): owner v2-уточнение wake-мандата

Owner words: его предложения — не требования («я в этом не эксперт... критиковать, другие брать, отвергать
полностью»); нужен research (визуальная ясность + процесс максимальной автоматизации + стратегия);
конечная цель — деньги, а он не знает даже базового (издатель? Kickstarter? прямые продажи?) — research
обязан разобрать варианты под нашу игру/ситуацию; нужен «маркетинговый волк» — автономный эксперт-контур,
меряющий стратегии; не generic-стратегия; ЕДИНСТВЕННОЕ требование — не тратить деньги, делать через
AI-ПРОЦЕССЫ без слопа (многошаговые: эскиз→деталь→деталь, сборка из частей); траты только где AI не
заменит (токены, dev-ускоряющие ассеты, реклама на лаунче — со скрипом); капсула $300–400 или знакомый
художник — крайний-крайний случай, приоритет — пайплайн.

Delta: wake-launch-2026-07-11.md переписан (v2: цель-деньги, B1 не-generic стратегия / B2 путь к деньгам /
B3 контур «маркетинговый эксперт», C без-слопа пайплайн, D визуальная ясность, единственное жёсткое
требование выделено); brief §Расширение — прежние «два требования» заменены v2-уточнением; NOW note
c-marketing-wake-001 и board-карточка синхронизированы.
