...
outcome: |
  ...
  1) work/board/dashboard.html — владельческая панель перенесена в репозиторий; ПОПРАВКА владельца
     в той же сессии: панель живёт ТОЛЬКО в репо, обновления только в репо, внешние зеркала не
     ведутся. Свежая секция «Борд» сгенерирована по NOW@2026-07-11
...
captures:
  ...
  - Правило владельца (2026-07-11, дословно): «артефакт ТОЛЬКО в репо! и обновляем только в репо» — зеркала отменены; ранее опубликованная claude.ai-страница больше не обновляется (удалить её из этой сессии нельзя — владелец может убрать сам в галерее артефактов).
