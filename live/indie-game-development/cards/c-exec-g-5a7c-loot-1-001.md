...
description: Набор лута по рукам в комнатах дома, библиотекой; и лут становится твёрдым
  для лута
_pos: 81
unblock_when: новый наряд от сохранённого e0a30194 (ветка preserve/...-win-u1-local-20260813)
  чинит окно контакта
---
...
END_OF_FILE: live/indie-game-development/cards/c-exec-g-5a7c-loot-1-001.md
