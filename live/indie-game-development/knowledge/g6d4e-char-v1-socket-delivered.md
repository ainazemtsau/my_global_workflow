...
## Дальше
- **В2:** тело (риг + процедурная локомоция + реакция/нокдаун/вставание в no-op хуках NullBodyReactions +
  косметический PuppetMaster рэгдолл) через ТОТ ЖЕ сейм. Owner-gated: timing + гейтинг под v21.
