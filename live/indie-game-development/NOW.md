...
updated: 2026-07-31 by s-frame-burrow-raiders-charter-revision-001
...
open_calls:
  - id: c-research-burrow-passage-and-cargo-001
    status: ready
    to: research
    for: g-0c26
    issued: 2026-07-31
    call: work/c-research-burrow-passage-and-cargo-001-call.md
    note: "map_evidence перед map нового концепта: перенос груза и изменяемый проход как одно решение игрока; победителя не выбирает."
