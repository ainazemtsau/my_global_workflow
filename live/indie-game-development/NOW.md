...
updated: 2026-07-30 by s-repair-g-37a1-simple-gas-recut-001
...
open_calls:
  - id: c-exec-g-37a1-simple-gas-rest-001
    ...
    note: "Путь 2, выбранный владельцем дословным «2» и утверждённый дословным «Да» на точный экран проектного решения: старый закон газа НЕ ремонтируется, рядом пишется новый простой закон без накопителя остатка. НОВЫЙ change_id и новый пакет; c-exec-g-37a1-gas-rest-and-checksum-001 неприкосновенен и его лиза в WIN-U4 не отбирается. Слот WIN-U1 вынужден фактом: селектор даёт AVAILABLE / lease none только для него. Пин 34 — репозиторий консолидирован на 34, новые корни пинуются текущим. Реестр обязан быть около двенадцати рядов; ряд, охраняющий старую машинерию, — признак захода в старый закон."
