...
open_calls:
  ...
  - id: c-marketing-wake-001
    ...
    issued: 2026-07-11
    note: "READY: owner verdict «будить минимально» 2026-07-11 + расширение мандата тем же днём; сессия исполняет substrate строго по work/marketing/wake-minimal-2026-07-11.md (апп-проверка — owner-run шаг, хэндлы, AI-капсула, текст страницы, письмо Valve) и несёт research-мандат из §Расширение (стратегия под наш случай, AI-контент-пайплайн, дашборд трека — бумага/проектирование); публичные действия БЕЗ отдельного owner-«да» НЕ входят; параллельна инженерным линиям."
recurring: []
