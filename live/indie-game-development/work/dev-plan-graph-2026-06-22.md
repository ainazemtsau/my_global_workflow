...
| **S2** Мультиплеер (lockstep) | тот же грубый сим на 2 инстансах бит-идентично; **binding-детерминизм проба = грубое бит-идентично + co-located пузыри воспроизводимы** | два окна — одинаковый газ | S0 (S1 желательно) | — (несущая) |
