...
| dr-20260711-004 | 2026-07-11 | night | P1 | **Canon law and Direction truth were corrected 15.07; canon-board render drift remains:** the live canon-board still exposes active `1–4 / solo-startable` player-count language instead of the current Frame-v2 direction `4–8 / mandatory eight / lower bound below four OPEN / solo not current target`. INDEX/QUEUE/card c-001 and several board statements also still disagree about the completed `ADMIT TO CANON` state. A future bounded canon-board regeneration owns both render remainders; canon content itself is not changed by this finding. | known |
...
CLOSED / FIXED by `s-repair-primary-review-post-b4-v26-001`.
The embedded pre-B1 repair CALL is historical and non-runnable. The primary review packet now carries L1a delivery,
completed B1–B4 / OS v26, the owner-reported GasCoopGame v26 Re-sync, retired v22 authority and separate owner-gated
L1b truth without running the review or opening a downstream CALL.
...
| id | дата | класс | P | факт | статус |
|---|---|---|---|---|---|
| dr-20260714-001 | 2026-07-14 | repair | P1 | `s-repair-primary-review-post-b4-v26-001` обновил primary M1 review packet до L1a DELIVERED @400ef8ec, completed B1–B4 / OS v26 и owner-reported GasCoopGame v26 Re-sync; старый v22 route остаётся retired/forbidden, L1b отдельна и owner-gated, `NOW.next` сохранён, review/verdict/downstream CALL не запускались. | fixed |
