...
До октября мало времени, канон пересобирается, а продукт делает один человек. Новые идеи должны быстро приводить к наблюдаемому результату. Пока октябрьский маршрут действует, при конфликте сначала сокращается объём, а не переносится внешний срок. Если маршрут закрыт или пропущен, даты и способ публичного выпуска демо пересматриваются явно; молчаливый перенос запрещён.
