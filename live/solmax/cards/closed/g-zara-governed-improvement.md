...
8. An activated candidate enters a bounded canary/observation period with
   incident and regression monitoring. A previously owner-authorized critical
   condition can safely suspend it, the rollback path is exercised, and any
   re-enable after suspension requires the owner's exact verdict.
9. One complete cycle from a real problem reaches accepted improvement or
