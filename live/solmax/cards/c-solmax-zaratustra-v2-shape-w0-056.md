---
id: c-solmax-zaratustra-v2-shape-w0-056
_kind: call
to: session
play: shape
for: g-zara-w0-core-text
status: ready
issued: 2026-09-04
call: work/calls/c-solmax-zaratustra-v2-shape-w0-056.md
description: 'Волна 0 «Ядро текстом» в ставку: аппетит, вырезы, вердикты по линзам,
  задачи по полдня, converge OFF'
_pos: 18
---
...
END_OF_FILE: live/solmax/cards/c-solmax-zaratustra-v2-shape-w0-056.md
