# solmax — owner-directive ledger (moved verbatim from NOW.md hot-state, 2026-07-14)
#
# Хронологический леджер owner-одобрений/каведатов/коррекций по operating-substrate.
# Перенесён из live/solmax/NOW.md, чтобы hot-state оставался маленьким. Ничего не удалено —
# скопировано дословно. Авторитетный (более полный) источник замороженных решений:
# work/operating-substrate/cards/ (8 карт) + history/.
...
END_OF_FILE: live/solmax/work/operating-substrate/owner-directive-ledger.md
