...
- owner quality/check sections in procedures, protocols, templates, interfaces, setup docs, source/legacy policies, and quality/recovery docs;
...
| Owner quality coverage | Owning procedures, protocols, templates, interfaces, setup docs, source/legacy policies, and quality/recovery docs expose pass/warn/fail-equivalent checks and recovery action where material. | required per package result |
