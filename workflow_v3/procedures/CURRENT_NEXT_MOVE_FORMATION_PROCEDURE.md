...
old_source_path: workflow_v3/formation/CURRENT_NEXT_MOVE_FORMATION_RUNBOOK.md

old_file_retained_as_migration_source: true

## purpose

Represent the registered Current Next Move formation entrypoint without executing the old source body in the active procedure model.

## trigger_when_to_use

- Use when START selects `form_current_next_move`.

## when_not_to_use

- Do not use to form a Current Next Move until the body is migrated.
...
- accepted state, pending decision, or result context.
