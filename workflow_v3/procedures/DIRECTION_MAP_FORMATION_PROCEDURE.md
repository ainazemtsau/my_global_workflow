...
old_source_path: workflow_v3/formation/DIRECTION_MAP_FORMATION_RUNBOOK.md

old_file_retained_as_migration_source: true

## purpose

Represent the registered Direction Map formation entrypoint without executing the old source body in the active procedure model.

## trigger_when_to_use

- Use when START selects `form_direction_map`.

## when_not_to_use

- Do not use to form a candidate Map until the body is migrated.
