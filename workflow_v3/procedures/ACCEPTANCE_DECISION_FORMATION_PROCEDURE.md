...
old_source_path: workflow_v3/formation/ACCEPTANCE_DECISION_FORMATION_RUNBOOK.md

old_file_retained_as_migration_source: true

## purpose

Represent the registered Acceptance Decision formation entrypoint without executing the old source body in the active procedure model.

## trigger_when_to_use

- Use when START selects `accept_candidate_entity`.

## when_not_to_use

- Do not use to form an Acceptance Decision until the body is migrated.
...
- candidate result and evidence context.
...
purpose: prevent execution of unmigrated acceptance-review logic
