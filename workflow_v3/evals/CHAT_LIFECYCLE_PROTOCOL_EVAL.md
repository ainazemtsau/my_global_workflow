...
- START begins with an operator-readable `Operator Brief`.
- START states the selected main procedure, selection reason, chat goal, terminal condition, possible child call need, and operator review items in human-readable form.
...
- STAGE_RESULT includes an operator-readable summary when material conclusions, blockers, repair needs, or child calls exist.
