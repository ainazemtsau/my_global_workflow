...
- FINISH audit includes `start_goal_was_explicit`, `start_goal_satisfied_or_explicitly_blocked`, `declared_stage_sequence_not_compressed`, `no_open_child_procedure_calls`, `all_required_child_returns_received`, `all_required_child_returns_verified`, `no_handoff_card_or_package_used_as_completion`, `required_validation_present_when_work_required_validation`, `closure_check_gaps_empty_or_blocked_completion_explicit`, and `next_chat_card_not_used_for_unfinished_child_work`.
