...
- Closure derives continuation from selected main procedure, actual result, completion check, unresolved work, and next intended workflow step.
- If continuation is needed, closure includes `NEXT_CHAT_CARD`.
