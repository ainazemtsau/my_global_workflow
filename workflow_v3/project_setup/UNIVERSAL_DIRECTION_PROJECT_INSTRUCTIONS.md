...
- Project Files/Sources are cache/context; inspect exact repo files when state matters and stop on missing/stale/conflicting source.
...
- After accepted root, generate per-Direction Instructions source; require manual UI update.
