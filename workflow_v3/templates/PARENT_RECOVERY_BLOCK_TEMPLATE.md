# Parent Recovery Block Template

status: template

## Parent Recovery Block

`parent_recovery_block_id`:

`parent_chat_target`:

`parent_source_authority`:
...
`exact_user_instruction_if_parent_chat_lost`:
...
END_OF_FILE: workflow_v3/templates/PARENT_RECOVERY_BLOCK_TEMPLATE.md
