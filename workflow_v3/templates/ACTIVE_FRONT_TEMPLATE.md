...
`procedure_path`: workflow_v3/procedures/ACTIVE_FRONT_FORMATION_PROCEDURE.md

`quality_check_owner`: workflow_v3/procedures/ACTIVE_FRONT_FORMATION_PROCEDURE.md#future_body_quality_requirements
