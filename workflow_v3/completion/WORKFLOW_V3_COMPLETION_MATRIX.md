...
| Routing/dependency calls | `workflow_v3/control_plane/ROUTING_AND_DEPENDENCY_PROTOCOL.md`; `workflow_v3/control_plane/SUPPORT_DEPENDENCY_PROTOCOL.md` | `workflow_v3/interfaces/10_CODEX_PROVIDER_INTERFACE.md` | `workflow_v3/evals/CHAT_LIFECYCLE_HANDOFF_EVAL.md` | repository_framework_coverage_complete | DEPENDENCY_CALL and DEPENDENCY_RETURN return to the same main procedure and require verification before reliance; prior packet labels are unsupported. |
