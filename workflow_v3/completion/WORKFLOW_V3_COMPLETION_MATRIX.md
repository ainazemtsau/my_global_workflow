...
| Procedure registry | `workflow_v3/control_plane/PROCEDURE_REGISTRY.md`; `workflow_v3/control_plane/RUN_SURFACE_CONTRACTS.md` | procedure stubs and authored bodies under `workflow_v3/procedures/**` | `workflow_v3/evals/ACTION_ADMISSION_EVAL.md`; `workflow_v3/evals/PROCEDURE_DEFINITION_EVAL.md` | complete | Active registry refs point to canonical procedure files; Direction Definition body is authored and active. |
| Direction structure | `workflow_v3/interfaces/01_DIRECTION_STRUCTURE_INTERFACE.md`; `workflow_v3/RUNTIME_MODEL.md` | `workflow_v3/templates/DIRECTION_SPINE_TEMPLATE.md`; `workflow_v3/templates/DIRECTION_MAP_TEMPLATE.md`; `workflow_v3/templates/ACTIVE_FRONT_TEMPLATE.md` | `workflow_v3/evals/DIRECTION_RUNTIME_BOOTSTRAP_EVAL.md`; direction lifecycle gate | complete | Direction Spine Formation body is authored and active; no real Direction is adopted until a later accepted package. |
...
| Goal Evidence Graph and Active Unresolved Cut | `workflow_v3/interfaces/14_GOAL_EVIDENCE_GRAPH_INTERFACE.md`; `workflow_v3/RUNTIME_MODEL.md` | `workflow_v3/templates/GOAL_EVIDENCE_GRAPH_TEMPLATE.md`; `workflow_v3/templates/GOAL_EVIDENCE_NODE_TEMPLATE.md`; `workflow_v3/templates/ACTIVE_UNRESOLVED_CUT_TEMPLATE.md` | `workflow_v3/evals/GOAL_EVIDENCE_GRAPH_EVAL.md`; `workflow_v3/evals/ACTIVE_UNRESOLVED_CUT_EVAL.md`; `workflow_v3/evals/NO_SINGLE_TRACK_COLLAPSE_EVAL.md` | complete | Graph/cut artifacts are steering/control projections, not semantic primitives or accepted state by existence. |
