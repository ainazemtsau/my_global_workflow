...
| Procedure registry | `workflow_v3/control_plane/PROCEDURE_REGISTRY.md`; `workflow_v3/control_plane/RUN_SURFACE_CONTRACTS.md` | active procedures and pending-authoring stubs under `workflow_v3/procedures/**` | `workflow_v3/evals/ACTION_ADMISSION_EVAL.md`; `workflow_v3/evals/PROCEDURE_DEFINITION_EVAL.md` | complete | Active registry refs point to canonical procedure files; procedure status/index consistency is validated by `workflow_v3/tools/check_procedure_status_index_sync.py`. |
