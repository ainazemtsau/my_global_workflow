...
- `workflow_v3/interfaces/03_DIRECTION_LIFECYCLE_SIGNAL_INTERFACE.md` - lifecycle signals and handlers.
...
- `workflow_v3/interfaces/07_EVENT_LOOP_AND_ROUTING_INTERFACE.md` - Event Loop, routing, Signal, Handler, Action Inbox, and Check Job interface.
