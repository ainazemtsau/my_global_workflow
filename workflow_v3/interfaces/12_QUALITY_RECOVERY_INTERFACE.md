...
| entity coverage gate | Every registry entity has definition, storage if any, packet coverage where relevant, mutation rights, and recovery coverage. |
| direction lifecycle gate | Lifecycle transitions are procedure-output, closure, and acceptance visible until accepted. |
