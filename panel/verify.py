...
def step00() -> None:
    ...
    try:
        ...
        for d in dirs:
            ...
            check(ready == ["slots", "waiting", "wave", "goals", "ideas", "history", "knowledge", "direction"],
                  f"{d.get('id')}: готовы slots, waiting, wave, goals, ideas, history, knowledge, direction — найдено {ready}")
