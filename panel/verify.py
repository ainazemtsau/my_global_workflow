...
def step00() -> None:
    ...
    try:
        ...
        for d in dirs:
            ...
            check(ready == ["dashboard", "slots", "waiting", "wave", "goals", "ideas", "history", "knowledge", "direction"],
                  f"{d.get('id')}: готовы dashboard, slots, waiting, wave, goals, ideas, history, knowledge, direction — найдено {ready}")
